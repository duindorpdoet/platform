...
export default async function PortalRegistrationPage() {
  ...
  const portalRegistrationOpen = (publicSnapshot?.data as { portalRegistrationOpen?: boolean } | null)?.portalRegistrationOpen ?? true;
