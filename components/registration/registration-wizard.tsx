...
type Draft = { adult: { name: string; phone: string }; children: ChildDraft[]; togetherCode: string; marketingConsent: boolean };
...
const emptyDraft: Draft = { adult: { name: "", phone: "" }, children: [{ name: "", age: "", accessibilityNote: "" }], togetherCode: "", marketingConsent: false };
