...
export const activityActionLabels: Record<string, string> = {
  ...
  "payment.batch_cancelled": "Gezamenlijke betaallink ingetrokken",
  "payment.batch_cancelled_for_child_change": "Betaallink ingetrokken na wijziging van kinderen",
  "payment.batch_cancelled_for_child_removal": "Betaallink ingetrokken na verwijderen van kind",
  "payment.batch_confirmed": "Gezamenlijke betaling bevestigd",
  "payment.batch_published": "Gezamenlijke betaallink verstuurd",
  "payment.child_batch_cancelled_for_child_removal": "Betaallink voor kinderen ingetrokken",
  "payment.child_cancelled": "Betaallink voor kind ingetrokken",
  "payment.child_confirmed": "Betaling voor kind bevestigd",
  "payment.child_marked_unpaid": "Kind als niet betaald gemarkeerd",
  "payment.child_published": "Betaallink voor kind verstuurd",
  ...
  "payment.external_link_set": "Betaallink toegevoegd",
  "payment.legacy_link_withdrawn": "Eerdere betaallink ingetrokken",
...
export const activitySourceLabels: Record<string, string> = {
  child_payment_batch: "Betaallink voor kind",
  ...
  payment_batch: "Gezamenlijke betaallink",
